...
export default function InventoryPage() {
  ...
  return (
    <div className="space-y-8 max-w-5xl mx-auto p-4">
      ...
      <div className="flex items-center justify-between relative">
        ...
        <div className="relative">
          <button
            ...
            className="relative"
          >
            <Bell className="w-7 h-7 text-green-700 hover:text-green-700 cursor-pointer" />
            {notifications.length > 0 && (
              <span className="absolute -top-2 -right-2 bg-red-500 text-white text-xs rounded-full px-2 py-0.5 animate-pulse">
                {notifications.length}
              </span>
          ...
          {showNotifications && (
            <div className="absolute right-0 mt-3 w-72 bg-white border rounded-lg shadow-lg p-3 z-50">
              {notifications.length > 0 ? (
      ...
      <form
        onSubmit={handleAdd}
        className="flex flex-col md:flex-row gap-2 items-center  p-4 rounded-lg shadow"
      >
        <input
          className="px-2 py-1 border rounded w-32"
          placeholder="Name"
        ...
        <button
          type="submit"
          className="bg-green-800 text-white px-4 py-1 rounded flex items-center gap-2 hover:bg-green-900 shadow"
        >
          <Plus className="w-4 h-4" /> Add Medicine
        </button>
      </form>
